...
export default function Search3({ navigation, logado }) {
  ...
  return (
    <ImageBackground
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.textMain}>Fretar</Text>
        ...
        <View style={styles.box}>
          ...
          <TextInput style={styles.boxSearch} placeholder="Valor de Frete"></TextInput>
        </View>
